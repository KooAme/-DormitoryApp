...
function SetHlth(props) {
  ...
  function confirm(e) {
    ...
    if(date === undefined || sTime === undefined || eTime === undefined) {
    ...
    <>
      ...
      >
        ...
        <div className="sTime">
          ...
          <select className="form-contorol" id="sTime" onChange={e => { setSTime(e.target.value) }}>
        ...
        <div className="eTime">
          ...
          <select className="form-contorol" id="eTime" onChange={e => {setETime(e.target.value)}}>
            <option value="07:00:00">07:00</option>
            <option value="08:00:00">08:00</option>
            <option value="09:00:00">09:00</option>
            <option value="10:00:00">10:00</option>
